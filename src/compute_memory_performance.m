function [performance] = compute_memory_performance(images, V_line_E, T_Iapp)
    ...
    for j = 1:num_learned_patterns
        ...
        % pattern_id = pattern_id(2); % If patterns are repeated in the test, you need to change this
