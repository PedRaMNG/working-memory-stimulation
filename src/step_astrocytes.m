function [Ca, h, IP3, W_WM, array_I_neuro, Gli_global, ...
    neuron_astrozone_input_timings] = ...
    step_astrocytes(neuron_astrozone_activity_Glu, ...
                    array_I_neuro, i, Ca, h, IP3, W_WM, Gli_global,...
	...
	for j = 1 : params.mastro
        for k = 1 : params.nastro
            ...
            if (Ca(j, k) > params.ca_threshold_global) ...
                ...
                W_WM(j, k, i : i + params.impact_astro) = 1; %This timing is constantly being updated
            end
            
            
            % Whole-cell gliotransmitter for WM 
            if (Ca(j, k) > params.ca_threshold_global) && (W_WM(j,k,i)) && (neuron_astrozone_activity_Glu(j, k) >= params.Glu_recall_global)
